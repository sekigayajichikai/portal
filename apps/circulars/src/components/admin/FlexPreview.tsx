        ...
        <div className="flex">
          <Bubble>
            ...
            <div className="px-3 pb-3 pt-2 mt-auto">
              ...
              <a href={link.url} target="_blank" rel="noopener noreferrer" className="block text-center rounded-lg py-2 text-sm font-bold text-white" style={{ background: '#b45309' }}>
                詳しく見る
              </a>
            </div>
          </Bubble>
