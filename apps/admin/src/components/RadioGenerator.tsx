...
import { generateRadioScript, generateRadioAudio } from '@cc-saas/shared';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            広報誌や回覧板から、Spotify等で配信できるラジオ番組を自動生成します。
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <div
            className={`bg-white p-6 rounded-2xl shadow-sm border border-slate-200 transition-opacity duration-300 ${!generatedScript ? 'opacity-50 pointer-events-none' : 'opacity-100'}`}
          >
            <label className="block text-sm font-bold text-slate-700 mb-2">
              2. 生成された台本 (編集可能)
            </label>
