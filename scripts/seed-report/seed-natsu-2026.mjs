/**
 * 関ヶ谷レポート 第1号「みんなで作った櫓（やぐら）」を写真・動画込みで投入する
 *
...
const ARTICLE_TITLE = '納涼大会2026：あの櫓、じつは脚立でできています';
/** 過去に使ったタイトル。タイトル変更後も同じ記事を更新できるように残す */
const PREVIOUS_TITLES = ['みんなで作った櫓（やぐら）'];
...
![照明櫓の光を浴びてソーランを踊る子どもたち。この後、アンコールの声が上がった](${urls.soran})
...
脚立を貸してくれた人、設営に来てくれた人、模擬店に立ってくれた人。納涼大会は、そんなみんなのちょっとした協力でできています。来年の夏も、この公園に櫓の灯りがともりますように。
